...
build-example: build
	mkdir -p example/.terraform/plugins/terraform.local/chendisheng/keycloak/2.0.0/darwin_amd64
	cp terraform-provider-keycloak example/.terraform/plugins/terraform.local/chendisheng/keycloak/2.0.0/darwin_amd64/
