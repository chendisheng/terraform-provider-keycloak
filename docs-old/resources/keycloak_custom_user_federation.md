...
An example of this implementation can be found [here](https://github.com/chendisheng/terraform-provider-keycloak/tree/master/custom-user-federation-example).
